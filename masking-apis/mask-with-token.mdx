...
description: >-
  Mask known sensitive values by explicitly specifying the token type. Use when
  you already know the data type and don't need structure preservation.
---
...
| ------ | ------- | --------------------------------------- |
| PUT    | `/mask` | `Authorization: Bearer YOUR_AUTH_TOKEN` |
