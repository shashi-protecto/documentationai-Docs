...
- This endpoint identifies only — it does not mask or tokenize values. To mask identified entities, use the [Identify and Mask](./identify-and-mask) endpoint instead.
