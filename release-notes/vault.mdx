...
---
<Update label="Sep 2026" description="v9.0.0" tags={["Enhancement"]}>
...
<Update label="June 2026" description="v8.0.6" tags={["Enhancement"]}>
...
<Update label="April 2026" description="v8.0.4" tags={["Enhancement"]}>
  ...
  **Note**:**&#x20;CITY, COUNTRY**, and **PINCODE&#x20;**&#x61;re derived sub-entities extracted from the existing ADDRESS entity. They provide more granular location data without requiring separate detection logic.&#x20;
</Update>
