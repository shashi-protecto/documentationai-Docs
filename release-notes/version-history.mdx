...
<Update label="April 2026 — GPT Guard" description="v8.0.4-prod" tags={["Major Release"]}>
  ### GPT Guard Phase 3 Release Notes

  #### Overview

  GPT Guard Phase 3 expands enterprise readiness of  SharePoint-based context ingestion, enhanced observability for chat latency, new Gemini 3 and Nano Banana model options, and higher configurability in the chatbot UI.
