...
| Requirement      | Notes                                                                             |
| ---------------- | --------------------------------------------------------------------------------- |
| Protecto account | For POC/Trial access, contact us at [sales@protecto.ai](mailto:sales@protecto.ai) |
...
<Steps>
  <Step title="Request access" icon="user-plus" title-type="p">
    For POC/Trial access, please contact us at [sales@protecto.ai](mailto:sales@protecto.ai). Our team will help you get set up with an account.
  </Step>
