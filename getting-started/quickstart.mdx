...
title: Quickstart
description: >-
  Make your first Protecto API call in under 5 minutes — create an account, get
  a token, mask sensitive data, and unmask it.
---
...
<Steps>
  <Step title="Sign up" icon="user-plus" title-type="p">
    Visit<a href="https://www.protecto.ai/trial/" target="_blank" rel="noopener noreferrer"> </a>[https://protecto.ai/trial](https://www.protecto.ai/trial/)and create a free account. Activate your account using the email verification link.
  </Step>
...
Please contact help@protecto.ai for url
