...
description: "Apply a named policy during unmasking to control re-identification behavior and enforce governance rules."
---
...
<ParamField body="policy_name" param-type="string" required="false">
