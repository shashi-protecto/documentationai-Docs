...
title: Unmask
description: >-
  Restore original sensitive values from tokenized text. The API resolves all
  embedded entity tokens automatically — no token_name required.
---
...
<Request show-lines="true" tabs="JSON,cURL,Python">
  ```bash
  curl -X PUT {baseurl}/api/vault/unmask \
