...
|-----|--------|----------------------|
| Mask | `PUT` | `{base_url}/api/vault/mask` |
| Unmask | `PUT` | `{base_url}/api/vault/unmask` |
| Mask Async | `PUT` | `{base_url}/api/vault/mask/async` |
| Async Status | `PUT` | `{base_url}/api/vault/async-status` |
