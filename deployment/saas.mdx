...
|-----|--------|----------------------|
| Mask | `PUT` | `{baseurl}/api/vault/mask` |
| Unmask | `PUT` | `{baseurl}/api/vault/unmask` |
| Mask Async | `PUT` | `{baseurl}/api/vault/mask/async` |
| Async Status | `PUT` | `{baseurl}/api/vault/async-status` |
