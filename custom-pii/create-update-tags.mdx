...
<ParamField body="identification_endpoint_details.url" param-type="string" required="true">
  URL of your external identification service.
</ParamField>

<ParamField body="identification_endpoint_details.method" param-type="string" required="true">
  HTTP method for the identification endpoint (typically `"PUT"` or `"POST"`).
</ParamField>

<ParamField body="identification_endpoint_details.headers" param-type="object" required="false">
