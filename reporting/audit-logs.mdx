...
| Method | Endpoint |
|--------|----------|
| `GET` | `{baseurl}/api/vault/namespace/reports/audit-details` |
...
```bash
curl -X GET "{baseurl}/api/vault/namespace/reports/audit-details?start_date=2024-06-01+00:00:00&end_date=2024-06-01+23:59:59" \
...
response = requests.get(
    "{baseurl}/api/vault/namespace/reports/audit-details",
    headers={
